...
public final class EntryUtils {
    ...
    public static void m8302a(Activity activity) {
        ...
        if (EffectDetect.usingAudioPlus()) {
            try {
                activity.startActivityForResult(new Intent("android.media.action.DISPLAY_AUDIO_EFFECT_CONTROL_PANEL").putExtra("android.media.extra.AUDIO_SESSION", Preferences.m2981aZ()).addFlags(AccessibilityEventCompat.TYPE_GESTURE_DETECTION_START), 1);
            } catch (Exception e) {
    ...
    public static void m8297a(boolean z) {
        ...
        c.startActivity(new Intent(c, LoginActivity.class).addFlags(268435456));
    }
}
