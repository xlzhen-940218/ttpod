...
public class ActionListDialog extends ListDialog<ActionItem> {
    ...
    public ActionListDialog(Context context, List<ActionItem> list, InterfaceC1142a interfaceC1142a, OnClickListener<? extends ListDialog> onClickListener, OnClickListener<? extends ListDialog> onClickListener2) {
