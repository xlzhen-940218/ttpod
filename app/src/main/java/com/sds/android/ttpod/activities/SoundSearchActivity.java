...
public class SoundSearchActivity extends SlidingClosableActivity {
    ...
    private Handler mHandler = new Handler() { // from class: com.sds.android.ttpod.activities.SoundSearchActivity.1
        ...
        public void handleMessage(Message message) {
            if (message.what == 0) {
                SoundSearchActivity.this.mRecognizeAnimView.setVolume(((Double) CommandCenter.m4607a().m4602a(new Command(CommandID.GET_SEARCH_RECOGNIZE_VOLUME, new Object[0]), Double.class)).doubleValue());
    ...
    public void searchRecognizeError(SoundRecognizer.EnumC1975a enumC1975a) {
        LogUtils.m8388a(TAG, "searchRecognizeError: " + enumC1975a);
    ...
    private void processResults(SoundSearchInfo[] soundSearchInfoArr) {
        LogUtils.m8388a(TAG, "search start ");
        ...
        TaskScheduler.m8582a(new TaskScheduler.AbstractAsyncTaskC0595a<SoundSearchInfo[], SoundSearchInfo[]>(soundSearchInfoArr) { // from class: com.sds.android.ttpod.activities.SoundSearchActivity.5
            ...
            public void postExecute(SoundSearchInfo[] soundSearchInfoArr2) {
                LogUtils.m8388a(SoundSearchActivity.TAG, "search end, cost time: " + (System.currentTimeMillis() - SoundSearchActivity.this.mStartTime) + "ms");
                LogUtils.m8388a(SoundSearchActivity.TAG, "search end, result: " + Arrays.toString(soundSearchInfoArr2));
    ...
    public void startSoundSearch() {
        CommandCenter.m4607a().m4606a(new Command(CommandID.START_SEARCH_RECOGNIZE, new Object[0]));
    ...
    public void stopSoundSearch() {
        CommandCenter.m4607a().m4606a(new Command(CommandID.STOP_SEARCH_RECOGNIZE, new Object[0]));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void cancelSoundSearch() {
        CommandCenter.m4607a().m4606a(new Command(CommandID.CANCEL_SEARCH_RECOGNIZE, new Object[0]));
    ...
    public void updateUI(EnumC0680a enumC0680a) {
        ...
        if (!isFinishing()) {
            LogUtils.m8388a(TAG, "updateUI mState: " + enumC0680a);
