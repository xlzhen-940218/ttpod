...
public class QQZoneAuthHandler extends AuthHandler {
    ...
    public QQZoneAuthHandler(Activity activity) {
        super(activity);
        try {
            this.tencent = Tencent.createInstance("100240447", this.activity.getApplicationContext());
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
    ...
    public void mo2059c(final AuthCallback authCallback) {
        ...
        try {
            ...
            this.tencent.login(this.activity, "add_share,add_pic_t", new BaseIUiListener() { // from class: com.sds.android.ttpod.share.b.f.1
            ...
            authCallback.onError(e.toString());
            e.printStackTrace();
        }
    }
