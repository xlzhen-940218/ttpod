...
public class SongPublishSectionView extends SimpleSongView {
    ...
    protected void mo1456b(View view, Object obj) {
        ...
        ImageCacheUtils.m4752a(imageView, musicCircleFirstPublish.getPicUrl(), DisplayUtils.m7225c() / 4, DisplayUtils.m7225c() / 4, (int) R.drawable.img_background_song_publish);
    }
}
