        ...
        this.mConfirmView.setOnClickListener(new View.OnClickListener() { // from class: com.sds.android.ttpod.activities.local.MediaPickerActivity.1
            ...
            public void onClick(View view) {
                ...
                if (MediaPickerActivity.this.mMediaItemsInGroup.size() > 0) {
                    CommandCenter.m4607a().m4606a(new Command(CommandID.DELETE_MEDIA_ITEM_LIST, MediaPickerActivity.this.mPickerObjectGroupId, MediaPickerActivity.this.mMediaItemsInGroup, false));
                }
                if (selectedMediaItems.size() > 0) {
                    CommandCenter.m4607a().m4606a(new Command(CommandID.ADD_MEDIA_ITEM_LIST, MediaPickerActivity.this.mPickerObjectGroupId, selectedMediaItems));
                }
