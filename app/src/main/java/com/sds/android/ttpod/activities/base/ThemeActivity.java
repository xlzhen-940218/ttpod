...
public class ThemeActivity extends BaseActivity {
    ...
    public void onLoadCommandMap(Map<CommandID, Method> map) throws NoSuchMethodException {
        ...
        Class<?> cls = getClass();
        map.put(CommandID.UPDATE_HEADSET_PLUGGED, ReflectUtils.loadMethod(cls, "headSetPlugged", new Class[0]));
        map.put(CommandID.UPDATE_DOWNLOAD_TASK_STATE, ReflectUtils.loadMethod(cls, "updateTaskState", DownloadTaskInfo.class));
        map.put(CommandID.UPDATE_ADD_DOWNLOAD_TASK_ERROR, ReflectUtils.loadMethod(cls, "updateAddDownloadTaskError", DownloadTaskInfo.class));
        ...
        map.put(CommandID.DOWNLOAD_TASK_FAILED, ReflectUtils.loadMethod(cls, "onDownloadTaskFailed", DownloadTaskInfo.class, Task.ErrorCodeType.class));
        map.put(CommandID.UPDATE_COMMON_UPGRADE_INFO, ReflectUtils.loadMethod(cls, "updateCommonUpgradeInfo", CommonResult.class));
        map.put(CommandID.UPDATE_SMART_UPDATE_INFO, ReflectUtils.loadMethod(cls, "updateSmartUpgradeInfo", VersionUpdateData.class));
        map.put(CommandID.UPDATE_ADD_DOWNLOAD_TASK_LIST_ERROR, ReflectUtils.loadMethod(cls, "updateAddDownloadTaskListError", List.class));
        map.put(CommandID.APP_THEME_CHANGED, ReflectUtils.loadMethod(getClass(), "onThemeChanged", new Class[0]));
        map.put(CommandID.UPDATE_PLAY_ERROR, ReflectUtils.loadMethod(getClass(), "updatePlayError", Integer.class));
        map.put(CommandID.UNICOM_FLOW_POPUP_DIALOG, ReflectUtils.loadMethod(getClass(), "unicomFlowPopupDialog", UnicomFlowDialogType.class));
    }
