...
public class AlbumSearchFragment extends BaseSearchFragment {
    ...
    public void onLoadCommandMap(Map<CommandID, Method> map) throws NoSuchMethodException {
        ...
        map.put(CommandID.UPDATE_SEARCH_ALBUM_FINISHED, ReflectUtils.loadMethod(getClass(), "updateSearchAlbum", AlbumItemsResult.class));
    }
    ...
    private class C1714a extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            ImageCacheUtils.displayImage(c1715b.f5469b, albumItem.getPic200(), DisplayUtils.dp2px(50), DisplayUtils.dp2px(50), (int) R.drawable.img_album_list_item_cover_default);
