...
public enum CommandID {
    ...
    DOWNLOAD_TASK_FAILED(ModuleID.DOWNLOAD_MANAGER, CommandType.FROM_MODULE, DownloadTaskInfo.class, Task.EnumC0579b.class),
    ...
    DOWNLOAD_STATE_CHANGED(ModuleID.MONITOR, CommandType.FROM_MODULE, DownloadTaskInfo.class, Task.EnumC0579b.class),
