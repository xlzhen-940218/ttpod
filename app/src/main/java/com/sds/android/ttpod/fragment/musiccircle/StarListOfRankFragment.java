...
public class StarListOfRankFragment extends StarListFragment {
    ...
    public void onRequestData(int i, int i2, int i3) {
        CommandCenter.getInstance().execute(new Command(CommandID.REQUEST_STAR_USERS_BY_RANK, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), "star_user_by_rank"));
    }
