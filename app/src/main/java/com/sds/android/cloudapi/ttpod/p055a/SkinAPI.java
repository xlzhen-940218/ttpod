...
public class SkinAPI {
    ...
    public static Request<OnlinePagedSkinListResult> m8829a(int i, int i2, int i3) {
        return new GetMethodRequest(OnlinePagedSkinListResult.class, "http://api.skin.ttpod.com/skin", "apiSkinType/info").m8537b("_id", Integer.valueOf(i)).m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i2)).m8537b("size", Integer.valueOf(i3));
    }
    ...
    public static Request<OnlinePagedSkinListResult> m8827b(int i, int i2, int i3) {
        return new GetMethodRequest(OnlinePagedSkinListResult.class, "http://log.topit.me/ttpod/apiSkinTypeInfo.php").m8537b("_id", Integer.valueOf(i)).m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i2)).m8537b("size", Integer.valueOf(i3));
    }
}
