...
public final class RadioAPI {
    ...
    public static Request<OnlineMediaItemsResult> m8836a(int i, int i2) {
        return new GetMethodRequest(OnlineMediaItemsResult.class, "http://fm.api.ttpod.com").m8542a("channelsong").m8537b("tagid", Integer.valueOf(i)).m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i2)).m8537b("size", "50");
    }
