...
public final class MusicCircleRecommendAPI {
    ...
    public static Request<RecommendPostResult> m8879a(int i, int i2) {
        return new GetMethodRequest(RecommendPostResult.class, f2267a, "more_recomm").m8537b("userId", EnvironmentUtils.C0603b.m8488e().get("tid")).m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i)).m8537b("size", Integer.valueOf(i2));
    }
    ...
    public static Request<FirstPublishNewSongMoreResult> m8877b(int i, int i2) {
        return new GetMethodRequest(FirstPublishNewSongMoreResult.class, f2267a, "new_songs_more").m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i)).m8537b("size", Integer.valueOf(i2));
    }
    ...
    public static Request<FirstPublishNewAlbumResult> m8875c(int i, int i2) {
        return new GetMethodRequest(FirstPublishNewAlbumResult.class, f2267a, "new_albums").m8537b(SEvent.FIELD_PAGE, Integer.valueOf(i)).m8537b("size", Integer.valueOf(i2));
    }
}
