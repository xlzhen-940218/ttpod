...
public class OnlineMediaSearchAPI {
    ...
    public static Request<BaseResult> m8862a(String str) {
        return new GetMethodRequest(BaseResult.class, "http://collect.log.ttpod.com/error/searchsong/index.html").m8537b("q", str).m8540a(EnvironmentUtils.C0603b.m8488e());
    }
    ...
    public static Request<AlbumItemsResult> m8858b(String str, int i, int i2, String str2) {
        return m8859b(str, i, i2).m8537b("sugg", str2);
    }
